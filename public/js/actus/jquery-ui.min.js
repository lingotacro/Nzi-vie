...
(function (t) {
        ...
        t.position = {
            ...
            return v = s(_), _[0].preventDefault && (n.at = "left top"), p = v.width, f = v.height, m = v.offset, g = t.extend({}, m), t.each(["my", "at"], function () {
                ...
                var s, r, h = t(this), l = h.outerWidth(), u = h.outerHeight(), d = i(this, "marginLeft"),
                    ...
                    C = u + v + i(this, "marginBottom") + y.height, D = t.extend({}, g),
    ...
    t.extend(s.prototype, {
        ...
        _generateHTML: function (t) {
            var e, i, s, n, o, a, r, h, l, u, c, d, p, f, m, g, v, _, b, y, w, x, k, C, D, T, M, S, I, P, N, A, H, z, O,
                E, W, F, L, R = new Date,
                ...
                K = this._get(t, "navigationAsDateFormat"), V = this._getNumberOfMonths(t),
                U = this._get(t, "showCurrentAtPos"), J = this._get(t, "stepMonths"), G = 1 !== V[0] || 1 !== V[1],
